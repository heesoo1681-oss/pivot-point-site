    ...
    <div className="min-h-screen bg-zinc-50 text-zinc-900">
      <div className="mx-auto max-w-4xl px-6 py-14">
        ...
        <header className="flex flex-col gap-6">
          <div className="inline-flex w-fit items-center rounded-full border border-zinc-200 bg-white px-4 py-2 text-sm font-medium">
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            ...
            <a
              href="/events"
              className="inline-flex items-center justify-center rounded-xl border border-zinc-300 bg-white px-5 py-3 text-sm font-semibold text-zinc-900 hover:bg-zinc-100"
            >
              See Format & Events
            </a>
          </div>
        ...
        {/* Footer disclaimer */}
        <footer className="mt-14 border-t border-zinc-200 pt-6 text-sm leading-6 text-zinc-600">
