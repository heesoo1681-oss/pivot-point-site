    ...
    <div className="min-h-screen bg-blue-50 text-white-900">
      <div className="mx-auto max-w-4xl px-6 py-14">
        ...
        <main className="mt-14 grid gap-10">
          ...
          <section className="rounded-2xl border border-sky-200 bg-white p-6">
            <h2 className="text-black text-xl font-semibold">Our goal</h2>
            <p className="mt-3 leading-7 text-zinc-700">
          ...
          <section className="rounded-2xl border border-sky-200 bg-white p-6">
            <h2 className="text-black text-xl font-semibold">What we do</h2>
            <ul className="mt-4 grid gap-4 sm:grid-cols-3">
              <li className="rounded-xl border border-sky-200 p-4">
                <div className="text-black text-xl font-semibold">Psychology insight</div>
              ...
              <li className="rounded-xl border border-sky-200 p-4">
                <div className="text-black text-xl font-semibold">Student story</div>
                <div className="mt-2 text-zinc-700 text-sm leading-6">
                  Personal stories and reflection—so you realize you’re not the only one.
                </div>
              </li>
              <li className="rounded-xl border border-sky-200 p-4">
                <div className="text-black text-xl font-semibold">Skill mini-workshop</div>
                <div className="mt-2 text-zinc-700 text-sm leading-6">
          ...
          <section className="rounded-2xl border border-sky-200 bg-white p-6">
            ...
            <div className="mt-4 flex flex-col gap-3 sm:flex-row">
              <a
                href="/links"
                className="inline-flex items-center justify-center rounded-xl border border-zinc-300 bg-white px-5 py-3 text-black text-xl font-semibold hover:bg-zinc-100"
              >
